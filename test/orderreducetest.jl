...
@testset "FullJPManySpins220" begin 

    dwOfile = "./OperatorShifts/FullNPTest/FullG2Take4/dwOOps/dwOcoefficients.csv"

    H1Afile = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H1A.csv"
    H1Bfile = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H1B.csv"
    H2Afile = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H2A.csv"
    H2Bfile = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H2B.csv"
    H3Afile = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H3A.csv"
    H3Bfile = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H3B.csv"
    H4Afile = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H4A.csv"
    H4Bfile = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H4B.csv"
    H10file = "./OperatorShifts/FullNPTest/FullG2Take4/HOps/H10.csv"

    I1Afile = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I1A.csv"
    I1Bfile = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I1B.csv"
    I2Afile = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I2A.csv"
    I2Bfile = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I2B.csv"
    I3Afile = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I3A.csv"
    I3Bfile = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I3B.csv"
    I4Afile = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I4A.csv"
    I4Bfile = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I4B.csv"
    I10file = "./OperatorShifts/FullNPTest/FullG2Take4/IOps/I10.csv"
    ...
    filename = "C:/Users/dwuuu/Documents/UT Academics/Research/Ringdown/Mathematica/FullNP/QNMPlots/JPShiftsHighRes" * string(l, m, n) * ".csv"
    
    for a in collect(.8+1e-8:0.01:1.)
        ...
        ℋ1Aplus = Integrate(H1Aplus, TheContourup,abstol=1e-7)[1]
        ℋ1Bplus = Integrate(H1Bplus, TheContourup,abstol=1e-7)[1]
        ℋ2Aplus = Integrate(H2Aplus, TheContourup,abstol=1e-7)[1]
        ℋ2Bplus = Integrate(H2Bplus, TheContourup,abstol=1e-7)[1]
        ℋ3Aplus = Integrate(H3Aplus, TheContourup,abstol=1e-7)[1]
        ℋ3Bplus = Integrate(H3Bplus, TheContourup,abstol=1e-7)[1]
        ℋ4Aplus = Integrate(H4Aplus, TheContourup,abstol=1e-7)[1]
        ℋ4Bplus = Integrate(H4Bplus, TheContourup,abstol=1e-7)[1]
        ℋ10plus = Integrate(H10plus, TheContourup,abstol=1e-7)[1]
        println("Done ℋplus")

        ℐ1Aplus = Integrate(I1Aplus, TheContourup,abstol=1e-7)[1]
        ℐ1Bplus = Integrate(I1Bplus, TheContourup,abstol=1e-7)[1]
        ℐ2Aplus = Integrate(I2Aplus, TheContourup,abstol=1e-7)[1]
        ℐ2Bplus = Integrate(I2Bplus, TheContourup,abstol=1e-7)[1]
        ℐ3Aplus = Integrate(I3Aplus, TheContourup,abstol=1e-7)[1]
        ℐ3Bplus = Integrate(I3Bplus, TheContourup,abstol=1e-7)[1]
        ℐ4Aplus = Integrate(I4Aplus, TheContourup,abstol=1e-7)[1]
        ℐ4Bplus = Integrate(I4Bplus, TheContourup,abstol=1e-7)[1]
        ℐ10plus = Integrate(I10plus, TheContourup,abstol=1e-7)[1]
        println("Done ℐplus")

        ∂ω𝒪plus = Integrate(dwOplus, TheContourup,abstol=1e-7)[1]
        ℋplus = ℋ1Aplus+ℋ1Bplus+ℋ2Aplus+ℋ2Bplus+ℋ3Aplus+ℋ3Bplus+ℋ4Aplus+ℋ4Bplus+ℋ10plus
        ℐplus = ℐ1Aplus+ℐ1Bplus+ℐ2Aplus+ℐ2Bplus+ℐ3Aplus+ℐ3Bplus+ℐ4Aplus+ℐ4Bplus+ℐ10plus

        # Downwards-facing contours

        ℋ1Aminus = conj(Integrate(H1Aminus, TheContourdown,abstol=1e-7)[1])
        ℋ1Bminus = conj(Integrate(H1Bminus, TheContourdown,abstol=1e-7)[1])
        ℋ2Aminus = conj(Integrate(H2Aminus, TheContourdown,abstol=1e-7)[1])
        ℋ2Bminus = conj(Integrate(H2Bminus, TheContourdown,abstol=1e-7)[1])
        ℋ3Aminus = conj(Integrate(H3Aminus, TheContourdown,abstol=1e-7)[1])
        ℋ3Bminus = conj(Integrate(H3Bminus, TheContourdown,abstol=1e-7)[1])
        ℋ4Aminus = conj(Integrate(H4Aminus, TheContourdown,abstol=1e-7)[1])
        ℋ4Bminus = conj(Integrate(H4Bminus, TheContourdown,abstol=1e-7)[1])
        ℋ10minus = conj(Integrate(H10minus, TheContourdown,abstol=1e-7)[1])
        println("Done ℋminus")

        ℐ1Aminus = conj(Integrate(I1Aminus, TheContourdown,abstol=1e-7)[1])
        ℐ1Bminus = conj(Integrate(I1Bminus, TheContourdown,abstol=1e-7)[1])
        ℐ2Aminus = conj(Integrate(I2Aminus, TheContourdown,abstol=1e-7)[1])
        ℐ2Bminus = conj(Integrate(I2Bminus, TheContourdown,abstol=1e-7)[1])
        ℐ3Aminus = conj(Integrate(I3Aminus, TheContourdown,abstol=1e-7)[1])
        ℐ3Bminus = conj(Integrate(I3Bminus, TheContourdown,abstol=1e-7)[1])
        ℐ4Aminus = conj(Integrate(I4Aminus, TheContourdown,abstol=1e-7)[1])
        ℐ4Bminus = conj(Integrate(I4Bminus, TheContourdown,abstol=1e-7)[1])
        ℐ10minus = conj(Integrate(I10minus, TheContourdown,abstol=1e-7)[1])
        println("Done ℐminus")

        ∂ω𝒪minus = conj(Integrate(dwOminus, TheContourdown,abstol=1e-7)[1])
        ℋminus = ℋ1Aminus+ℋ1Bminus+ℋ2Aminus+ℋ2Bminus+ℋ3Aminus+ℋ3Bminus+ℋ4Aminus+ℋ4Bminus+ℋ10minus
        ℐminus = ℐ1Aminus+ℐ1Bminus+ℐ2Aminus+ℐ2Bminus+ℐ3Aminus+ℐ3Bminus+ℐ4Aminus+ℐ4Bminus+ℐ10minus
...
@testset "FullJPTake2" begin 
    ...
    ℋ1Aplus = Integrate(H1Aplus, TheContourup,abstol=1e-6)[1]
    ℋ1Bplus = Integrate(H1Bplus, TheContourup,abstol=1e-6)[1]
    ℋ2Aplus = Integrate(H2Aplus, TheContourup,abstol=1e-6)[1]
    ℋ2Bplus = Integrate(H2Bplus, TheContourup,abstol=1e-6)[1]
    ℋ3Aplus = Integrate(H3Aplus, TheContourup,abstol=1e-6)[1]
    ℋ3Bplus = Integrate(H3Bplus, TheContourup,abstol=1e-6)[1]
    ℋ4Aplus = Integrate(H4Aplus, TheContourup,abstol=1e-6)[1]
    ℋ4Bplus = Integrate(H4Bplus, TheContourup,abstol=1e-6)[1]
    ℋ10plus = Integrate(H10plus, TheContourup,abstol=1e-6)[1]

    ℐ1Aplus = Integrate(I1Aplus, TheContourup,abstol=1e-6)[1]
    ℐ1Bplus = Integrate(I1Bplus, TheContourup,abstol=1e-6)[1]
    ℐ2Aplus = Integrate(I2Aplus, TheContourup,abstol=1e-6)[1]
    ℐ2Bplus = Integrate(I2Bplus, TheContourup,abstol=1e-6)[1]
    ℐ3Aplus = Integrate(I3Aplus, TheContourup,abstol=1e-6)[1]
    ℐ3Bplus = Integrate(I3Bplus, TheContourup,abstol=1e-6)[1]
    ℐ4Aplus = Integrate(I4Aplus, TheContourup,abstol=1e-6)[1]
    ℐ4Bplus = Integrate(I4Bplus, TheContourup,abstol=1e-6)[1]
    ℐ10plus = Integrate(I10plus, TheContourup,abstol=1e-6)[1]

    ∂ω𝒪plus = Integrate(dwOplus, TheContourup,abstol=1e-6)[1]
    ℋplus = ℋ1Aplus+ℋ1Bplus+ℋ2Aplus+ℋ2Bplus+ℋ3Aplus+ℋ3Bplus+ℋ4Aplus+ℋ4Bplus+ℋ10plus
    ℐplus = ℐ1Aplus+ℐ1Bplus+ℐ2Aplus+ℐ2Bplus+ℐ3Aplus+ℐ3Bplus+ℐ4Aplus+ℐ4Bplus+ℐ10plus

    # Downwards-facing contours

    ℋ1Aminus = conj(Integrate(H1Aminus, TheContourdown,abstol=1e-6)[1])
    ℋ1Bminus = conj(Integrate(H1Bminus, TheContourdown,abstol=1e-6)[1])
    ℋ2Aminus = conj(Integrate(H2Aminus, TheContourdown,abstol=1e-6)[1])
    ℋ2Bminus = conj(Integrate(H2Bminus, TheContourdown,abstol=1e-6)[1])
    ℋ3Aminus = conj(Integrate(H3Aminus, TheContourdown,abstol=1e-6)[1])
    ℋ3Bminus = conj(Integrate(H3Bminus, TheContourdown,abstol=1e-6)[1])
    ℋ4Aminus = conj(Integrate(H4Aminus, TheContourdown,abstol=1e-6)[1])
    ℋ4Bminus = conj(Integrate(H4Bminus, TheContourdown,abstol=1e-6)[1])
    ℋ10minus = conj(Integrate(H10minus, TheContourdown,abstol=1e-6)[1])

    ℐ1Aminus = conj(Integrate(I1Aminus, TheContourdown,abstol=1e-6)[1])
    ℐ1Bminus = conj(Integrate(I1Bminus, TheContourdown,abstol=1e-6)[1])
    ℐ2Aminus = conj(Integrate(I2Aminus, TheContourdown,abstol=1e-6)[1])
    ℐ2Bminus = conj(Integrate(I2Bminus, TheContourdown,abstol=1e-6)[1])
    ℐ3Aminus = conj(Integrate(I3Aminus, TheContourdown,abstol=1e-6)[1])
    ℐ3Bminus = conj(Integrate(I3Bminus, TheContourdown,abstol=1e-6)[1])
    ℐ4Aminus = conj(Integrate(I4Aminus, TheContourdown,abstol=1e-6)[1])
    ℐ4Bminus = conj(Integrate(I4Bminus, TheContourdown,abstol=1e-6)[1])
    ℐ10minus = conj(Integrate(I10minus, TheContourdown,abstol=1e-6)[1])

    ∂ω𝒪minus = conj(Integrate(dwOminus, TheContourdown,abstol=1e-6)[1])
    ℋminus = ℋ1Aminus+ℋ1Bminus+ℋ2Aminus+ℋ2Bminus+ℋ3Aminus+ℋ3Bminus+ℋ4Aminus+ℋ4Bminus+ℋ10minus
    ℐminus = ℐ1Aminus+ℐ1Bminus+ℐ2Aminus+ℐ2Bminus+ℐ3Aminus+ℐ3Bminus+ℐ4Aminus+ℐ4Bminus+ℐ10minus
