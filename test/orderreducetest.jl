...
@testset "FullJPManySpins220" begin 
    ...
    for a in collect(1e-8:0.01:0.9)

        ψ = qnmfunctionnew(-2,2,2,0,a)
        ψm = qnmfunctionnew(-2,2,2,0,a, is_minus=true)
        ψconj =  qnmfunctionnew(-2,2,2,0,a, is_conjugate=true)
        ψmconj = qnmfunctionnew(-2,2,2,0,a,is_conjugate=true,is_minus=true)
        ...
        push!(freqpertsmatrix, (2, 2, 0, a, ω2s[1], ω2s[3], ω2s[2], ω2s[4]))
    end

    CSV.write("C:/Users/dwuuu/Downloads/JPShiftsLargeSpin.csv", freqpertsmatrix)
