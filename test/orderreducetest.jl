...
@testset "JPPertToKerrManySpinsAdaptiveIntegrate" begin 
    ...
    for a in collect(0.97+1e-8:0.01:1.0)
...
@testset "JPPertToKerrManySpinsGroupIntegrate" begin 
    ...
    filename = "/home/dgw763/Documents/bGRQNMs/JPPertToKerr/QNMShifts/JPShifts" * string(l, m, n) * "Extra.csv"
    
    for a in collect(0.96+1e-8:0.01:1.0)
        ...
        ℋ1Aplus = Integrate(H1Aplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℋ1Bplus = Integrate(H1Bplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℋ2Aplus = Integrate(H2Aplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℋ2Bplus = Integrate(H2Bplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℋ3Aplus = Integrate(H3Aplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℋ3Bplus = Integrate(H3Bplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℋ4Aplus = Integrate(H4Aplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℋ4Bplus = Integrate(H4Bplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℋ10plus = Integrate(H10plus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        # ℋplus=Integrate(Hplus, TheContourup,reltol=1e-4, abstol=1e-13)[1]
        println("Done ℋplus")

        ℐ1Aplus = Integrate(I1Aplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℐ1Bplus = Integrate(I1Bplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℐ2Aplus = Integrate(I2Aplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℐ2Bplus = Integrate(I2Bplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℐ3Aplus = Integrate(I3Aplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℐ3Bplus = Integrate(I3Bplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℐ4Aplus = Integrate(I4Aplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℐ4Bplus = Integrate(I4Bplus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        ℐ10plus = Integrate(I10plus, TheContourup,reltol=1e-4,abstol=1e-13)[1]
        # ℐplus=Integrate(Iplus, TheContourup,reltol=1e-4, abstol=1e-13)[1]
        println("Done ℐplus")

        ∂ω𝒪plus = Integrate(dwOplus, TheContourup,reltol=1e-4, abstol=1e-13)[1]
        ℋplus = ℋ1Aplus+ℋ1Bplus+ℋ2Aplus+ℋ2Bplus+ℋ3Aplus+ℋ3Bplus+ℋ4Aplus+ℋ4Bplus+ℋ10plus
        ℐplus = ℐ1Aplus+ℐ1Bplus+ℐ2Aplus+ℐ2Bplus+ℐ3Aplus+ℐ3Bplus+ℐ4Aplus+ℐ4Bplus+ℐ10plus

        # Downwards-facing contours

        ℋ1Aminus = conj(Integrate(H1Aminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℋ1Bminus = conj(Integrate(H1Bminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℋ2Aminus = conj(Integrate(H2Aminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℋ2Bminus = conj(Integrate(H2Bminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℋ3Aminus = conj(Integrate(H3Aminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℋ3Bminus = conj(Integrate(H3Bminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℋ4Aminus = conj(Integrate(H4Aminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℋ4Bminus = conj(Integrate(H4Bminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℋ10minus = conj(Integrate(H10minus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        # ℋminus=conj(Integrate(Hminus, TheContourdown,reltol=1e-4, abstol=1e-13)[1])
        println("Done ℋminus")

        ℐ1Aminus = conj(Integrate(I1Aminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℐ1Bminus = conj(Integrate(I1Bminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℐ2Aminus = conj(Integrate(I2Aminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℐ2Bminus = conj(Integrate(I2Bminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℐ3Aminus = conj(Integrate(I3Aminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℐ3Bminus = conj(Integrate(I3Bminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℐ4Aminus = conj(Integrate(I4Aminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℐ4Bminus = conj(Integrate(I4Bminus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        ℐ10minus = conj(Integrate(I10minus, TheContourdown,reltol=1e-4,abstol=1e-13)[1])
        # ℐminus=conj(Integrate(Iminus, TheContourdown,reltol=1e-4, abstol=1e-13)[1])
        println("Done ℐminus")

        ∂ω𝒪minus = conj(Integrate(dwOminus, TheContourdown,reltol=1e-4, abstol=1e-13)[1])
        ℋminus = ℋ1Aminus+ℋ1Bminus+ℋ2Aminus+ℋ2Bminus+ℋ3Aminus+ℋ3Bminus+ℋ4Aminus+ℋ4Bminus+ℋ10minus
        ℐminus = ℐ1Aminus+ℐ1Bminus+ℐ2Aminus+ℐ2Bminus+ℐ3Aminus+ℐ3Bminus+ℐ4Aminus+ℐ4Bminus+ℐ10minus
...
@testset "JPPertToKerrManySpinsSingleIntegrate" begin 
    ...
    filename = "/home/dgw763/Documents/bGRQNMs/JPPertToKerr/QNMShifts/JPShifts" * string(l, m, n) * ".csv"
