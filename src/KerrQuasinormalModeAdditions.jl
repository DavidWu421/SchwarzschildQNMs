...
function qnmfunctionnew(s,l,m,n,a; qnm=qnm,modesign="plus",is_conjugate=false)
    ...
    qnmfunction(Custom; s=s,l=l,m=m,n=n,a=a,ω=ω,Alm=Alm,Cllʼ=Cllʼ,is_conjugate=is_conjugate)
end
